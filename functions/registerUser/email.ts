export const buildHtmlEmail = ({ email, actionUrl }) => {
  const HTMLEmail = `
<!DOCTYPE html
                          ...
                          <td align="center"
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                              <tr>
                                <td align="center"
                                  style="word-break: break-word; font-family: &quot;Inter&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                  <a href="{{ACTION_URL}}" class="f-fallback button" target="_blank"
                        ...
                        <tr>
                          <td
                            ...
                            <p class="f-fallback sub"
                              ...
                              align="center">Please ignore this email if you didn’t register to a based.io demo project.</p>
                          </td>
                        </tr>
                      </table>
                    </div>
...
`
  const HTMLBody = HTMLEmail.replace(/{{USER_EMAIL}}/g, email).replace(
    /{{ACTION_URL}}/g,
    actionUrl
  )
